...
class AppColors {
  ...
  // ============== Primary Colors ==============
  static const Color primary = Color(0xFF530404);
  static const Color primaryLight = Color(0xFF854854);
  ...
  // ============== Brand Colors (from auth module) ==============
  static const Color brown = Color(0xff60212E);
