...
class _ProfessionalDetailsScreenState
  ...
  /// Load existing professional details from registration state
  void _loadExistingData() {
    final registrationState = ref.read(registrationProvider);
    final professionalDetails =
        registrationState.registration?.professionalDetails;
    ...
    if (professionalDetails != null) {
      ...
      _experienceController.text =
          professionalDetails.yearsOfExperience.toString();
