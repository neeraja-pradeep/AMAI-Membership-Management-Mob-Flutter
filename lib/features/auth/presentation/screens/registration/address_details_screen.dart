...
class _AddressDetailsScreenState extends ConsumerState<AddressDetailsScreen> {
  ...
  /// Load existing address details from registration state
  void _loadExistingData() {
    final registrationState = ref.read(registrationProvider);
    final addressDetails = registrationState.registration?.addressDetails;
  ...
  void _saveAddressDetails() {
    ...
    ref.read(registrationProvider.notifier).updateAddressDetails(
          addressDetails,
        );
  }
