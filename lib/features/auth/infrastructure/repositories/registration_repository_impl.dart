...
class RegistrationRepositoryImpl implements RegistrationRepository {
  ...
  Future<String> submitRegistration({
    ...
    try {
      ...
      // Submit to API
      return await _api.submitRegistration(
  ...
  Map<String, dynamic> _convertRegistrationToJson(
    ...
    return {
      ...
      'professional_details': registration.professionalDetails != null
          ? {
              'council_id': registration.professionalDetails!.councilId,
              'registration_number': registration.professionalDetails!.registrationNumber,
              'registration_year': registration.professionalDetails!.registrationYear,
              'specialization_id': registration.professionalDetails!.specializationId,
              'qualification': registration.professionalDetails!.qualification,
              'institution': registration.professionalDetails!.institution,
            }
          : null,
      ...
      'payment_details': registration.paymentDetails != null
          ? {
              ...
              'completed_at': registration.paymentDetails!.completedAt?.toIso8601String(),
            }
          : null,
    };
  }
